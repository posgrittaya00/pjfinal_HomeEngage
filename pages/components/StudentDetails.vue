    ...
    <div class="student-details">
        ...
        <div class="row">
            ...
            <div class="field full-width">
                <label>ที่อยู่</label>
                <span class="detail-span" v-if="!isEditing">
                    {{ showFullAddress ? formData.Address : truncatedAddress }}
                    <a v-if="!showFullAddress" @click="showFullAddress = true" style="cursor: pointer;">ดูเพิ่มเติม</a>
                </span>
        ...
        <div class="row">
            ...
            <div class="field full-width">
                ...
                <span class="detail-span" v-if="!isEditing">
                    {{ showFullAddress ? formData.ParentAddress : truncatedAddress }}
                    <a v-if="!showFullAddress" @click="showFullAddress = true" style="cursor: pointer;">ดูเพิ่มเติม</a>
                </span>
        ...
        <div class="row">
            ...
            <div class="field">
                <label>ครอบครัวนักเรียนมีสมาชิกกี่คน</label>
            ...
            <div class="field">
                <label>ปัจจุบันมีพี่น้องกำลังศึกษากี่คน</label>
...
const truncatedAddress = computed(() => {
  return formData.value.Address.length > 30 ? formData.value.Address.slice(0, 30) + '...' : formData.value.Address;
});
