  ...
  <div class="container">
    ...
    <div class="main-content">
      ...
      <div class="content-area">
        ...
        <!-- Show student list -->
        <ProfileStudentTeacher :students="filteredStudents" :currentPage="currentPage"
          :studentsPerPage="studentsPerPage" />

        <!-- Pagination -->
        <Pagination :currentPage="currentPage" :totalPages="totalPages" @set-page="setPage" @prev="prevPage"
          @next="nextPage" />
      </div>
    </div>
  </div>
...
const students = ref([
  { stuId: "001", Name: "นายสมชาย ใจดี", stuClass: "ม.5/1", firstVisit: false, secondVisit: true },
...
.content-area {
  position: relative;
  /* ตั้งตำแหน่ง relative เพื่อให้ absolute ด้านในอ้างอิง */
  display: flex;
  flex-direction: column;
  /* จัดเรียงแนวตั้ง */
  flex: 1;
...
.pagination {
  ...
  padding: 10px 0;
  background-color: #F9F9F9;
  /* เพื่อให้ดูชัดเจนเมื่อชิดขอบล่าง */
  margin-bottom: 10px;
  /* เพิ่มระยะห่างระหว่างตารางและ Pagination */
}
</style>